...
<div class="h-full flex justify-between pt-10 sm:pt-0">
  ...
  {#if $isDisplayingBug}
    <div
      class="bugDisplay fixed top-0 bg-opacity-90 flex-grow bg-white w-full h-full py-5 sm:bg-transparent sm:relative sm:top-auto sm:w-fit transition-all border-l-4 border-gray-200"
